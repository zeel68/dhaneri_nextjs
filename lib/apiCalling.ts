...
class ApiClient {
  ...
  public async delete<T>(endpoint: string, data?: any, config?: AxiosRequestConfig): Promise<ApiResponse<T>> {
    return this.handleRequest(this.axiosInstance.delete<T>(endpoint, { ...config, data }))
  }
  ...
  public async request<T>(
    ...
    return this.handleRequest(this.axiosInstance.request<T>({ method, url: endpoint, data, ...config }))
  }
}
